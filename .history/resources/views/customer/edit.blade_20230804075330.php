        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" value="{{$customer->detail->phone ?? 'no data'}}">
                    </div>
                </div>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control" id="province" name="province" placeholder="Province" value="{{$customer->detail->province ?? 'no data'}}">
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <select class="form-control" name="country">
                            @foreach($countrieslist as $country)
                                <option value="{{ $country->id }}" @if($customer->country->country_name == $country->country_name ?? 'no data') selected @endif>{{ $country->country_name ?? 'no data'  }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
