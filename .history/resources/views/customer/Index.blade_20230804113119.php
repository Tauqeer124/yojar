                                ...
                                <tbody>
                                    ...
                                    @foreach($customers as $user)            
                                        <tr role="row" class="odd">
                                            ...
                                            <td> <a type="button" data-id="{{$user->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $user->status ? 'checked' : '' }}>
