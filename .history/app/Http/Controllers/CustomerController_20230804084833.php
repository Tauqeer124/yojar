...
class CustomerController extends Controller
{
    ...
    public function showgraph()
    {
        ...
        $customersByCountry = User::select('customers.country_id', 'countries.country_name ')
        ->leftJoin('countries', 'customers.country_id', '=', 'countries.id')->
        select(DB::raw('customer.country_id,countries.country_name, count(*) as count'))->groupby('country_name','country_id')->get();
        return view('users.graph', compact('customersByCountry'));
    }
}
