...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/customer_update/{id}',[CustomerController::class,'store'])->name('customer.update');
    Route::get('/customer_delete/{id}',[CustomerController::class,'edit'])->name('customer.delete');
